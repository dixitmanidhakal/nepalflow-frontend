...
const CATEGORY_ICONS: Record<string, string> = { general: '📄', promotion: '📢', product: '🛍️', event: '🎪', festival: '🎊', announcement: '📌', tip: '💡', quote: '💬', story: '📖' };
  ...
  const handleSave = async (data: TemplateFormData) => {
    try {
      ...
      const msg = e.response?.data?.error
        || (e.code === 'ERR_NETWORK' ? 'Cannot connect to server. Is the backend running?' : 'Failed to save template');
      toast.error(msg);
      throw err;
    }
  };
