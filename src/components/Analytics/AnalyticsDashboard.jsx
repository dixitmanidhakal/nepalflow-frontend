...
const PLATFORM_GRADIENT = {
  facebook: ['rgba(24,119,242,0.85)', 'rgba(24,119,242,0.6)'],
  instagram: ['rgba(225,48,108,0.85)', 'rgba(225,48,108,0.6)'],
  tiktok: ['rgba(238,29,82,0.85)', 'rgba(238,29,82,0.6)'],
};

function InsightCard({ icon, value, label, gradient, sublabel }) {
  return (
...
export default function AnalyticsDashboard() {
  ...
  const baseOptions = {
    responsive: true,
    plugins: {
      legend: { position: 'top', labels: { font: { size: 12, weight: '600' }, usePointStyle: true, pointStyleWidth: 8 } },
      tooltip: {
    ...
    scales: {
      y: { beginAtZero: true, grid: { color: 'rgba(0,0,0,0.04)', drawBorder: false }, ticks: { font: { size: 11 } } },
